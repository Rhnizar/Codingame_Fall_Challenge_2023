...
void    Avoid_Monster(My_drone drone, int Drone_NextX, int Drone_NextY)
{
    ...
    for(size_t j=0; j<drone.Monsters.size(); j++)
    {
        ...
        for(size_t i = 0; i<EstablishedPoints.size(); i++)
        {
            ...
            {
                if(distance(Dvp[r].x, Dvp[r].y, Mvp[r].x, Mvp[r].y) <= 510 || di <= 501)
                {
                    check = 1;
                    break;
                }
...
// void DefineStep(My_drone drone, string rad)
// {
//     if(drone.drone_x >= 0 && drone.drone_x <= 2500 && (rad == "BR" || rad == "TR"))
//         StepX = ..;
//     else if(drone.drone_x > 2500 && drone.drone_x <= 5000  && (rad == "BR" || rad == "TR"))
//         StepX = ..;
//     else if(drone.drone_x >= 0 && drone.drone_x <= 2500 && (rad == "BL" || rad == "TL"))
//         StepX = ..;
//     else if(drone.drone_x > 2500 && drone.drone_x <= 5000  && (rad == "BL" || rad == "TL"))
//         StepX = ..;
    

//     else if(drone.drone_x > 5000 && drone.drone_x <= 7500 && (rad == "BR" || rad == "TR"))
//         StepX = ..;
//     else if(drone.drone_x > 7500 && drone.drone_x <= 100000 && (rad == "BR" || rad == "TR"))
//         StepX = ..;
//     if(drone.drone_x > 5000 && drone.drone_x <= 7500 && (rad == "BL" || rad == "TL"))
//         StepX = ..;
//     else if(drone.drone_x > 7500 && drone.drone_x <= 100000 && (rad == "BL" || rad == "TL"))
//         StepX = ..;
...
//     if(drone.drone_y >= 0 && drone.drone_y <= 2500 && (rad == "BR" || rad == "BL"))
//         StepY = ..;
//     else if(drone.drone_y > 2500 && drone.drone_y <= 5000  && (rad == "BR" || rad == "BL"))
//         StepY = ..;
//     else if(drone.drone_y >= 0 && drone.drone_y <= 2500 && (rad == "TR" || rad == "TL"))
//         StepY = ..;
//     else if(drone.drone_y > 2500 && drone.drone_y <= 5000  && (rad == "TR" || rad == "TL"))
//         StepY = ..;
    
    
//     else if(drone.drone_y > 5000 && drone.drone_y <= 7500 && (rad == "BR" || rad == "BL"))
//         StepY = ..;
//     else if(drone.drone_y > 7500 && drone.drone_y <= 100000 && (rad == "BR" || rad == "BL"))
//         StepY = ..;
//     if(drone.drone_y > 5000 && drone.drone_y <= 7500 && (rad == "TR" || rad == "TL"))
//         StepY = ..;
//     else if(drone.drone_y > 7500 && drone.drone_y <= 100000 && (rad == "TL" || rad == "TR"))
//         StepY = ..;
...
void DefineStep(My_drone drone, string rad)
{
    // Scale factor for map dimensions
    int scaleFactor = 4;

    if (drone.drone_x >= 0 && drone.drone_x <= 2500)
    {
        if ((rad == "BR" || rad == "TR"))
            StepX = drone.drone_x / scaleFactor;
        else if ((rad == "BL" || rad == "TL"))
            StepX = -(drone.drone_x / scaleFactor);
    }
    else if (drone.drone_x > 2500 && drone.drone_x <= 5000)
    {
        if ((rad == "BR" || rad == "TR"))
            StepX = (drone.drone_x - 2500) / scaleFactor;
        else if ((rad == "BL" || rad == "TL"))
            StepX = -(drone.drone_x - 2500) / scaleFactor;
    }
    else if (drone.drone_x > 5000 && drone.drone_x <= 7500)
    {
        if ((rad == "BR" || rad == "TR"))
            StepX = (drone.drone_x - 5000) / scaleFactor;
        else if ((rad == "BL" || rad == "TL"))
            StepX = -(drone.drone_x - 5000) / scaleFactor;
    }
    else if (drone.drone_x > 7500 && drone.drone_x <= 10000)
    {
        if ((rad == "BR" || rad == "TR"))
            StepX = (drone.drone_x - 7500) / scaleFactor;
        else if ((rad == "BL" || rad == "TL"))
            StepX = -(drone.drone_x - 7500) / scaleFactor;
    }

    if (drone.drone_y >= 0 && drone.drone_y <= 2500)
    {
        if ((rad == "BR" || rad == "BL"))
            StepY = drone.drone_y / scaleFactor;
        else if ((rad == "TR" || rad == "TL"))
            StepY = -(drone.drone_y / scaleFactor);
    }
    else if (drone.drone_y > 2500 && drone.drone_y <= 5000)
    {
        if ((rad == "BR" || rad == "BL"))
            StepY = (drone.drone_y - 2500) / scaleFactor;
        else if ((rad == "TR" || rad == "TL"))
            StepY = -(drone.drone_y - 2500) / scaleFactor;
    }
    else if (drone.drone_y > 5000 && drone.drone_y <= 7500)
    {
        if ((rad == "BR" || rad == "BL"))
            StepY = (drone.drone_y - 5000) / scaleFactor;
        else if ((rad == "TR" || rad == "TL"))
            StepY = -(drone.drone_y - 5000) / scaleFactor;
    }
    else if (drone.drone_y > 7500 && drone.drone_y <= 10000)
    {
        if ((rad == "BR" || rad == "BL"))
            StepY = (drone.drone_y - 7500) / scaleFactor;
        else if ((rad == "TR" || rad == "TL"))
            StepY = -(drone.drone_y - 7500) / scaleFactor;
    }
    cerr << "   drone id  =   " << drone.drone_id << endl;
    cerr << "   StepX = " << StepX << "  StepY  =  " << StepY << endl;
    cerr << "   radar =   " << rad << endl;
}
...
{
    DefineStep(drone, rad);
    if(rad == "BR")
    {
        Target.x = drone.drone_x + 400;
        Target.y = drone.drone_y + 1000;
    }
    else if(rad == "BL")
    {
        Target.x = drone.drone_x - 400;
...
void    SepareteDrone(My_drone drone, vector<int> My_drone_scan, vector<Fish> fish, Point Target, int GlobalScan)
{
    ...
    // cerr << "     drone id  = " << drone.drone_id << endl;
    // cerr << "RadarType0.size()  == " << RadarType0.size() << "    RadarType0.size()  == " << RadarType1.size() << "    RadarType2.size()  == " << RadarType2.size() << endl;
    ...
    {
        if(drone.drone_y >= 2000 && drone.drone_y <= 3500 && RadarType0.size() > RadarType0.size() - SizeScanType0)
        {
            rad = Calculate_Numbers_Of_Radar(drone, RadarType0, fish);
            UseRadar(drone, rad, Target);
            // target type 0
        }
        else if(drone.drone_y > 4000 && drone.drone_y <= 6500 && RadarType1.size() > RadarType1.size() - SizeScanType1)
        {
